...
# Mail.ru top
mail_ru_top_abs = os.path.abspath("../russian_pps")
mrt_websites = f"{mail_ru_top_abs}/json/websites.json"
mrt_policies = f"{mail_ru_top_abs}/json/policies.json"
mrt_downloaded = f"{mail_ru_top_abs}/json/downloaded.json"
mrt_sanitized = f"{mail_ru_top_abs}/json/sanitized.json"
mrt_plain = f"{mail_ru_top_abs}/json/plain.json"
mrt_explicit = f"{mail_ru_top_abs}/json/explicit.json"
mrt_metrics = f"{mail_ru_top_abs}/json/metrics.json"

mrt_original_policies = f"{mail_ru_top_abs}/original_policies"
mrt_processed_policies = f"{mail_ru_top_abs}/processed_policies"
mrt_plain_policies = f"{mail_ru_top_abs}/plain_policies"
