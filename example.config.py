...
from tools.path_object import PathsObject

# Dataset paths
paths = PathsObject()
# paths.resources = os.path.relpath("../iot-dataset")
paths.resources = os.path.abspath("../privacy-policies-in-russian")
# paths.deploy = os.path.relpath("../iot-dataset-deploy")
paths.deploy = os.path.abspath("../privacy-policies-in-russian-deploy")

paths.explicit = "explicit.json"
paths.metrics = "metrics.json"
paths.archive = "dataset"

paths.json = PathsObject()
paths.json.products = "json/products.json"
paths.json.websites = "json/websites.json"
paths.json.policies = "json/policies.json"
paths.json.downloaded = "json/downloaded.json"
paths.json.sanitized = "json/sanitized.json"
paths.json.plain = "json/plain.json"

paths.dir = PathsObject()
paths.dir.original = "original_policies"
paths.dir.processed = "processed_policies"
...
# Webdriver settings
webdriver_settings = {
    # "profile_path": "/home/user/.mozilla/firefox/t16nvbdk.default-release",
    "profile_path": None,
    "temp_dir": "/mnt/windows/tmp",
    ...
    "headless": True,
    "use_proxy": False,
    "max_error_attempts": 50,
    "max_captcha_attempts": 50,
    "max_timeout_attempts": 50,
    "proxies": [
        "37.135.121.10:80",
        "104.248.90.212:80",
        "50.206.25.111:80",
